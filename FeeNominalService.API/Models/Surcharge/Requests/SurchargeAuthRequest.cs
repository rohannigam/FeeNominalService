...
/// <summary>
/// Request model for surcharge authorization operations
/// </summary>
public class SurchargeAuthRequest
{
    ...
    /// <summary>
    /// Total transaction amount including surcharge (optional)
    /// </summary>
    ...
    /// <summary>
    /// Campaign identifiers for surcharge calculation (optional)
    /// </summary>
    public List<string>? Campaign { get; set; }

    /// <summary>
    /// Additional data for surcharge calculation (optional)
    /// </summary>
    public List<string>? Data { get; set; }

    /// <summary>
    /// Tokenized card information (optional)
    /// </summary>
    ...
    /// <summary>
    /// Non-surchargable amount in cents (optional)
    /// </summary>
    public decimal? NonSurchargableAmount { get; set; }

    /// <summary>
    /// Provider transaction ID for follow-up operations (optional)
    /// </summary>
