/*
Rollback: U1_0_0_119__add_provider_transaction_id_rollback.sql
Description: Removes provider_transaction_id column from surcharge_trans table
Dependencies: 
- V1_0_0_19__add_provider_transaction_id.sql (rolls back this migration)
Changes:
...
DO $$
BEGIN
    RAISE NOTICE 'Starting U1_0_0_119__add_provider_transaction_id_rollback...';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE 'Completed U1_0_0_119__add_provider_transaction_id_rollback successfully';
END $$; 