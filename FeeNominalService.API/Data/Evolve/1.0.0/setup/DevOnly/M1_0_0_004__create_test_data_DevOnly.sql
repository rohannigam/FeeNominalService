-- =====================================================================
-- Title: Local DevOnly - Create Test Data for Development
-- File: M1_0_0_004__create_test_data_DevOnly.sql
-- Location: Data/Evolve/1.0.0/setup/
-- Purpose: MANUAL STEP - Creates test data for development and testing environments
--          ONLY run this in local development environments!
--          DO NOT run in production or staging environments!
-- =====================================================================

/*
Migration: M1_0_0_004__create_test_data_DevOnly.sql
...
DO $$
BEGIN
    RAISE NOTICE 'Starting M1_0_0_004__create_test_data_DevOnly migration (DEV ONLY)...';
    RAISE NOTICE 'WARNING: This migration creates test data for development only!';
END $$;
...
DO $$
BEGIN
    RAISE NOTICE 'Completed M1_0_0_004__create_test_data_DevOnly migration successfully (DEV ONLY)';
    RAISE NOTICE 'Remember: This migration is for development environments only!';
END $$;

-- =====================================================================
-- END OF FILE - DEVELOPMENT ONLY
-- ===================================================================== 