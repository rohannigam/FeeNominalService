...
namespace FeeNominalService.Controllers.V1
{
    ...
    public class AdminController : ControllerBase
    {
            ...
            [FromServices] IApiKeyService apiKeyService)
        {
            ...
            _logger.LogInformation("Admin API key generate requested with X-Timestamp: {Timestamp}, X-Nonce: {Nonce}", timestamp.ToString(), nonce.ToString());
            ...
            _logger.LogInformation("Looking up admin secret: {SecretName}", secretName);
            ...
            _logger.LogWarning("Admin API key generated by {User}", User.Identity?.Name ?? "Unknown");
            return Ok(response);
        }
